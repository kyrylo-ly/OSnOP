...
int main() {
    ...
    INT longestRun = 0;
    INT transitions = CountStableTransitionsW(states, 8, TRUE, &longestRun);
    ...
    INT score = 0;
    INT cls = EvaluatePasswordStrengthW("Lab5#Secure2026", 10, TRUE, '#', &score);
    assert(cls == 4);
    assert(score == 100);

    std::cout << "All Windows-type tests passed.\n";
